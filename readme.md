...
+ 2.3 Если почта не подтверждена в течении дня - письмо с предупреждением ГОТОВО
+ 2.4 Если почта не подтверждена в течении двух дней - деактивируем аккаунт ГОТОВО
...
4. order management
+ 4.1 Создать заказ (при создании заказа меняется количество товара на складе, нельзя заказать больше чем есть на складе) ГОТОВО
+ 4.2 При создании заказа отправлять письмо на электронную почту покупателю ГОТОВО
